                    ...
                    <div class="col-md-6 col-xl-auto">
                        <div class="widget footer-widget">
                            <div class="vs-widget-about">
                                <div class="footer-logo"> <a href="{{ url('/home') }}"><img
                                            src="https://youexceltraining.com/img/Yourexcel-img/Youexcel-logowhite.png"
                                            alt="logo"></a> </div>
                                <p class="footer-text">Let's help you start or advance your career.</p>
                                <p class="footer-text"> You have a question? <br> Let us know and our team is available
                                    to.
                                    guide you.</p>
                        ...
                        <div class="widget  footer-widget">
                            ...
                            <div class="menu-all-pages-container footer-menu">
                                <ul class="menu" style="padding: 0;">
                                    ...
                                    <li>
                                        <p class="footer-info"><i class="fa-light fa-phone"></i><a
                                                class="text-inherit" href="tel://+922137121738"> +92-21-37121738</a>
                                        </p>
                                    </li>

                                    <li>
                                        <p class="footer-info"><i class="fa-light fa-phone"></i><a
                                                class="text-inherit" href="http://wa.me/+923313016699"
                                                target="_blank"> +92-331-3016699</a></p>
                                    </li>
                                    <li>
                                        <p class="footer-info"><i class="fa-light fa-phone"></i><a
                                                class="text-inherit" href="http://wa.me/+923356699331"
                                                target="_blank"> +92-335-6699331</a></p>
                                    </li>
                                    <li>
                                        <p class="footer-info"><i class="fa-light fa-phone"></i><a
                                                class="text-inherit" href="http://wa.me/+923345669933"
                                                target="_blank"> +92-334-5669933</a></p>
                                    </li>
                                    <li>
                                        <p class="footer-info"><i class="fa-light fa-envelope"></i><a
                                                class="text-inherit" href="#"> info@youexceltraining.com</a></p>
                                    </li>
                                    <li>
                                        <p class="footer-info"><i class="fa-light fa-envelope"></i><a
                                                class="text-inherit" href="#"> info@youexceltraining.com</a></p>
                                    ...
                                    <li>
                                        <p class="footer-info"><i class="fa-light fa-envelope"></i><a
                                                class="text-inherit" href="{{ url('/contact') }}"> Contact Us</a></p>
                                    </li>
                                    {{--   <li>
                ...
                <div class="row justify-content-between align-items-center">
                    <div class="text-center col-lg-auto">
                        <p class="copyright-text">
                            COPYRIGHT <i class="fa-light fa-copyright"></i>
                            <script>
                                document.write(new Date().getFullYear());
                            </script> <a href="{{ url('/home') }}">YOUEXCEL</a>. All Rights Reserved
                            By <a href="https://supersofttechnology.com/"> DESIGN & DEVELOPED BY
                                SUPERSOFT TECHNOLOGIES</a>
                        </p>
                    </div>
