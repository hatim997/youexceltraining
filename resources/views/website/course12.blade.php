...
@section('content')
  ...
  ==============================-->
                ...
                <div class="col-lg-4">
                    <div class="course-meta-box wow fadeInUp ">
                        ...
                        <a href="{{$pdf}}" class="vs-btn"><i class="fas fa-hand-point-down"></i> Download Brochure Now</a><br/><br/>
                          ...
                          @endif
                        <a href="https://youexceltraining.com/enquiry-form/cyber-security" class="vs-btn">Enquire Now</a><br/><br/>
                                ...
                                <div class="accordion-body wow fadeInDown">
                                    <div class="syllabus-list">
                                        ...
                                        <div class="syllabus-content">
                                            <li class="syllabustext">The Need for Security? Why cyber security is now becoming necessary</li>
                                ...
                                <div class="accordion-body wow fadeInUp ">
                                    <div class="syllabus-list">
                                        <div class="syllabus-content">
                                            ...
                                            <li class="syllabustext">Ethical Hacking Concepts and Its Scope</li>
                                            <li class="syllabustext">Concept & Installation of VM</li>
                                            <li class="syllabustext">Installation of Linux over VM</li>
                                            <li class="syllabustext">Linux Basics</li>
                                            <li class="syllabustext">Overview of Ethical Hacking Tools</li>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="accordion-body wow fadeInUp ">
                                    <div class="syllabus-list">
                                        <div class="syllabus-content">
                                            ...
                                            <li class="syllabustext">Common Techniques Attackers use to Distribute Malware on the Web</li>
                                            <li class="syllabustext">Different Types of Malware and Malware Countermeasures</li>
                                            <li class="syllabustext">Vulnerability and Vulnerability Classification</li>
                                            <li class="syllabustext">Vulnerability Assessment and Types of Vulnerability Assessment</li>
                                            <li class="syllabustext">Vulnerability Assessment Tools and Vulnerability Exploitation</li>                                    
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                                ...
                                <div class="accordion-body wow fadeInDown">
                                    <div class="syllabus-list">
                                        ...
                                        <div class="syllabus-content">
                                            {{--                                            <h6 class="syllabustitle">Introduction</h6>--}}
                                            <li class="syllabustext">Social Engineering Concepts</li>
                                            ...
                                            <li class="syllabustext">Different Insider Threats and Identity Theft Countermeasures</li>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <li class="syllabustext">Different DoS/DDoS Attack Countermeasures and Protection Tools</li>
    <li class="syllabustext">Hijacking and Types of Session Hijacking</li>
    <li class="syllabustext">Different Session Hijacking Tools and Countermeasures</li>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="collapseFour2" class="accordion-collapse collapse" aria-labelledby="headingFour"
                                ...
                                <div class="accordion-body wow fadeInDown">
                                    <div class="syllabus-list">
                                        ...
                                        <div class="syllabus-content">
                                            {{--                                            <h6 class="syllabustitle">Introduction</h6>--}}
                                            <li class="syllabustext">Fundamentals of Penetration Testing and its Benefits</li>
    <li class="syllabustext">Strategies and Phases of Penetration Testing</li>
    <li class="syllabustext">Guidelines and Recommendations for Penetration Testing</li>
                                        </div>
                                    </div>
                                </div>
                            </div>
              ...
              <div class="process-style1 d-flex align-items-center">
               ...
               <div class="process-content">
                 <h6 class="process-title">
                    Examine Fundamentals of information security and ethical hacking
  ...
  <span class="process-number"><i class="fas fa-circle"></i></span>
               <div class="process-content">
                  <h6 class="process-title">
                    Illustrate Information security threats and vulnerabilities, types of malwares, and vulnerability assessments </h6>
        ...
        <span class="process-number"><i class="fas fa-circle"></i></span>
               <div class="process-content">
                  <h6 class="process-title">
                    Explain security ethics and landscape            </h6>
            ...
            <div class="process-style1 d-flex align-items-center">
             <span class="process-number"><i class="fas fa-circle"></i></span>
               <div class="process-content">
                  <h6 class="process-title">
                    Identify how security attacks impact business operations.</h6>
             ...
             <!--<p class=" pt-1 fs-md text-white">Enter your email id to get latest updates and  amazing discounts</p>-->
               <br>
                ...
                <form class="newsletter-form d-flex flex-row justify-content-center align-items-center">
                   <a href="../Registration-Form/cyber-security" class="vs-btn style2"><i class="far fa-angle-right"></i>GET REGISTERED HERE</a>
