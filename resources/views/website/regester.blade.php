...
<section class="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" id="file1" name="file1"style="border:none"
                                                   placeholder="">
                                        </div>
                                    </div>
                                     <div class="col-lg-6">
  ...
  <input class="form-check-input" type="checkbox" value="" required name="check" id="customCheck1">
...
">
                                ...
                                <div class="col-lg-12 mt-4 text-center">
                                    <button type="submit" id="submit1" class="vs-btn py-3">Submit
                                    </button>
                                </div>
                            </form>
                        </div>
