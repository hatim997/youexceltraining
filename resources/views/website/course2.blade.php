    ...
    <div class="breadcumb-wrapper " data-bg-src="">
        <div class="container z-index-common">
            <div class="breadcumb-content">
                             <h1 class="breadcumb-title">Go Beyond the Basics: Advanced Excel Training for Professionals. Enrol Now for Dashboard Reporting skills!</h1>
        ...
        <div class="container">
            ...
            <div class="row flex-row-reverse">
                <div class="col-lg-4">
                    <div class="course-meta-box wow fadeInUp ">
                        <table>
                          ...
                          <td> <img src="https://youexceltraining.com/img/Yourexcel-img/ae.jpg" /> </td>
                            ...
                            <tr style="padding-top: 8px;">
                                <td>
                                <i class="far fa-suitcase"></i>Difficulty Level:  &nbsp;  Intermediate to Advanced</td>
                             </tr>  
                                                         <tr>
                        ...
                        <a href="{{$pdf}}" class="vs-btn"><i class="fas fa-hand-point-down"></i> Download Brochure Now</a><br/><br/>
                          ...
                          @endif
                        <a href="https://youexceltraining.com/enquiry-form/advanced-excel" class="vs-btn">Enquire Now</a><br/><br/>
                ...
                <div class="col-lg-8">
                    ...
                    <h2 class="course-title animate__animated animate__bounceInDown"> Advanced MS Excel: Business Intelligence with Data Visualization  </h2>
                  ...
                  <div class="mb-3">
                    ...
                    <p  class="wow fadeInDown pb-3">Unleash the Power of MS Excel to master all the essential functions, tools and features taking your efficiency to Advance level. Introducing Python integration and AI features in MS Excel taking this program to whole new level of competence and expertise. Upon completion of this program, participants will become competent to use the advance level of Microsoft Excel, making them an invaluable resource for their companies; accelerate their productivity; and improve organizational performance.</p>
                                ...
                                <div class="accordion-body wow fadeInDown">
                                    <div class="syllabus-list">
                                        ...
                                        <div class="syllabus-content">
                                            <li class="syllabustext">Overview (Interface/Tools/Options)</li>
                                            <li class="syllabustext">Security (Editing/Restricted sharing/ Book-Sheet-Cell Protection)</li>
                                            <li class="syllabustext">Tips & Tricks (Short cut keys / Techniques)</li>
                        ...
                        <div class="accordion-item wow fadeInUp ">
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                ...
                                <div class="accordion-body wow fadeInUp ">
                                    <div class="syllabus-list">
                                        <div class="syllabus-content">
                                            <li class="syllabustext">Cleaning </li>
                                            <li class="syllabustext">Formulas (Text/Trim/IsText/Right/Left/Mid/Upper/Lower/Proper/Len/Clean/Find)</li>
                                            <li class="syllabustext">Conditional Formatting</li>
                                            <li class="syllabustext">Subtotal/Aggregate</li>
                                            <li class="syllabustext">Flash Fill/Fill Series</li>
                                            <li class="syllabustext">Text to Column (Fixed/Delimited)</li>
                                            <li class="syllabustext">Remove Duplicate (By Conditional Formatting)</li>
                                            <li class="syllabustext">Tips & Tricks (Short Keys/Techniques)</li>
                                ...
                                <div class="accordion-body wow fadeInUp ">
                                    <div class="syllabus-list">
                                        <div class="syllabus-content">
                                            ...
                                            <li class="syllabustext">Group/UnGroup Data</li>
                                            <li class="syllabustext">Conditional Formatting (Simple/Advance)</li>
                                            <li class="syllabustext">Data Consolidations</li>
                                            <li class="syllabustext">Filtering (Simple/Advance)</li>
                                            <li class="syllabustext">Tips & Tricks (Short Keys/Techniques)</li>
                            ...
                            <div id="collapseFour44" class="accordion-collapse collapse" aria-labelledby="headingFour"
                                ...
                                <div class="accordion-body wow fadeInDown">
                                    <div class="syllabus-list">
                                        ...
                                        <div class="syllabus-content">
                                            {{--                                            <h6 class="syllabustitle">Introduction</h6>--}}
                                            <li class="syllabustext">Time Intelligence (Datedif/Now/Today)</li>
                                            <li class="syllabustext">Logical Operations and Functions (IF/IFS/OR/NOT/AND/SUMIFS/COUNTIFS/AVGIFS/MAXIFS/MINIFS/SWITCH)</li>
                                            <li class="syllabustext">Look-Ups (VLOOKUP/HLOOKUP/INDEX/MATCH)</li>
                                            <li class="syllabustext">Troubleshoot Formulas</li>
                                            <li class="syllabustext">Tips & Tricks (Shortcut Keys/Techniques)</li>
                            ...
                            <div id="collapseFour4" class="accordion-collapse collapse" aria-labelledby="headingFour"
                                ...
                                <div class="accordion-body wow fadeInDown">
                                    <div class="syllabus-list">
                                        ...
                                        <div class="syllabus-content">
                                            {{--                                            <h6 class="syllabustitle">Introduction</h6>--}}
                                   <li class="syllabustext">Taking the leverage of COPILOT for Insights/Analysis/Interpretation</li>
    <li class="syllabustext">Natural Language Queries and Commands</li>
    <li class="syllabustext">Advanced Auto Data Visualization techniques</li>
    <li class="syllabustext">Simplify Complex Calculation to enhance Productivity techniques</li>
                            ...
                            <div id="collapseFour3" class="accordion-collapse collapse" aria-labelledby="headingFour"
                                ...
                                <div class="accordion-body wow fadeInDown">
                                    <div class="syllabus-list">
                                        ...
                                        <div class="syllabus-content">
                                            {{--                                            <h6 class="syllabustitle">Introduction</h6>--}}
                                            <li class="syllabustext">	What If Analysis (All 3 Functions)</li>
                            ...
                            <div id="collapseFour2" class="accordion-collapse collapse" aria-labelledby="headingFour"
                                ...
                                <div class="accordion-body wow fadeInDown">
                                    <div class="syllabus-list">
                                        ...
                                        <div class="syllabus-content">
                                            {{--                                            <h6 class="syllabustitle">Introduction</h6>--}}
                                            <li class="syllabustext">	Power Query – ETL (Extract Transform Load)</li>
                                            <li class="syllabustext">	Automate Daily Task</li>
                                            <li class="syllabustext">	Table/Pivot Tables/Power Tables</li>
                                            <li class="syllabustext"> 	Tips & Tricks (Short cut Keys/ Techniques)</li>
                            ...
                            <div id="collapseFour11" class="accordion-collapse collapse" aria-labelledby="headingFour"
                                ...
                                <div class="accordion-body wow fadeInDown">
                                    <div class="syllabus-list">
                                        ...
                                        <div class="syllabus-content">
                                            {{--                                            <h6 class="syllabustitle">Introduction</h6>--}}
                                         <li class="syllabustext"> Theory discussion on types of visuals 
                                         (KPI’s card/Charts/Visuals/Slicer/Timeliner</li>
 <li class="syllabustext"> 	Create Automated System</li>
 <li class="syllabustext"> 	Create Automated Dashboards</li>
 <li class="syllabustext"> Tips & Tricks (Short cut Keys/ Techniques)</li>
                          ...
                          <div class="accordion-item wow fadeInUp ">
                            <div class="accordion-header d-flex" id="headingFour1">
                                <button class="accordion-button justify-content-between " type="button" data-bs-toggle="collapse"
                            ...
                            <div id="collapseFour1" class="accordion-collapse collapse" aria-labelledby="headingFour"
                                ...
                                <div class="accordion-body wow fadeInDown">
                                    <div class="syllabus-list">
                                        ...
                                        <div class="syllabus-content">
                                            {{--                                            <h6 class="syllabustitle">Introduction</h6>--}}
                                            <li class="syllabustext">Introduction to Data framework</li>
                                            <li class="syllabustext">Data Libraries</li>
...
<section class=" pb-5" id="div2">
         ...
         <div class="col-md-6 col-lg process-inner1 order-2 order-lg-1">
              <div class="process-style1 d-flex align-items-center">
               ...
               <div class="process-content">
                 <h6 class="process-title">Leverage tools and functions to format and prepare data in MS Excel</h6>
  ...
  <span class="process-number"><i class="fas fa-circle"></i></span>
               <div class="process-content">
                  <h6 class="process-title">Integrate data from various sources by using Power Query in MS Excel</h6>
        ...
        <span class="process-number"><i class="fas fa-circle"></i></span>
            ...
            <div class="process-style1 d-flex align-items-center">
             <span class="process-number"><i class="fas fa-circle"></i></span>
               <div class="process-content">
                  <h6 class="process-title">Use data security features to protect and distribute MS Excel files</h6>
             ...
             <span class="process-number"><i class="fas fa-circle"></i></span>
               <div class="process-content">
                  <h6 class="process-title">Introduction to using Python and AI features in MS Excel</h6>
             ...
             <span class="process-number"><i class="fas fa-circle"></i></span>
               <div class="process-content">
                  <h6 class="process-title">Present analysis dashboards with impact using MS Excel</h6>
      ...
      <div class="row   -animated" data--delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: ;">
         ...
         <div class="col-sm-6 col-xl-4">
            <div class="media-style9">
               ...
               <p>Apply formatting rules based on cell values, making it easy to highlight important data points.</p>
            </div>
         </div>
         <div class="col-sm-6 col-xl-4">
            <div class="media-style9">
...
">Uzair Rasheed</h5>
               <p class="about-text pe-xl-5 me-xl-3 fs-md">Uzair Rasheed: Overall more than 7 years of experience in FMCG, Telecom Industry, IT Group, HR Consultation,and textile sector, also experience in designing, developing, and implementing Power BI/Tableau solutions, including data models, handling large data sets, handling slowly changing dimensions, visualizations, and dashboards.
                </p>
                <p>
                    <ul>
                        <li>Experience of Tableau, calculated fields, calculated parameters, Tableau measures, Power BI</li>
                        <li>Measures, Power Query, DAX, calculated columns, dashboard creation and graph interpretation.</li>
                    </ul>
                                            He is currently associated with Systems Limited in the capacity of Associate Manager – Business Intelligence, further also serving as a seasonal consultant in Arthur Lawrence Group LLC (USA) as a Business Analyst. Uzair has previously served in Hilal Food Group Pvt Ltd and Zelbury Textiles Limited as well.
                </p>
    ...
    <!--        </div>-->
            ...
            <div class="col-lg-6">
            <div class="img-box3 mb-30">
               <div class="img-1 mega-hover"><img class="" src="{{ asset('/img/Yourexcel-img/uzair.jpg') }}" alt="About Img" style="
    width: 502px;
    border-radius: 50px;
"></div>
               <div class="shape-dotted jump"></div>
